...
PACKAGE_LISP          := repom.el helm-repom.el repom-git.el repom-github.el
...
install: .elpa
	PACKAGE_FILE=helm-repom.el $(EMAKE) install
	PACKAGE_FILE=repom-git.el $(EMAKE) install
	PACKAGE_FILE=repom-github.el $(EMAKE) install
	PACKAGE_FILE=repom.el $(EMAKE) install
lint: install
